...
Let's look at the RailsTrails data from the book.
...
this isn't quite what we wanted. So, we need to do something a little more complicated. Let's try a `stringr` function. 
