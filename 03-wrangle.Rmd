# Data wrangling for model assessment {#wrangle}
...
For more on QQ plots, see [this post by Sean Kross](https://seankross.com/2016/02/29/A-Q-Q-Plot-Dissection-Kit.html)
...
1. Try re-making a few more of our models from yesterday, and `glance`ing to see which one has the highest adjusted $R^2$. 
...
RMSE = \sqrt{MSE}
$$
1. Try using `dplyr` verbs to compute the RMSE. 
